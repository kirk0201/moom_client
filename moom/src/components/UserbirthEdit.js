...
class UserbirthEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      promise: "",
        ...
        <div className="mt-2 pb-4 inline-flex items-center w-full">
          ...
          <div className="flex justify-between items-center md:w-9/12">
            <div className="flex truncate md:w-10/12">
              <img className="w-5 h-8 pt-2 mr-3 text-gray-500" src={birthimg} alt="이미지 어디감?"></img>
              <input
                name={name} //"promise"
                type={type}
...
export default withRouter(UserbirthEdit);
